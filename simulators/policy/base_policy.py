...
class BasePolicy(ABC):
  obsrv_list: Optional[List] #type hinting

  @property
  @abstractmethod #prevents instantiations if child class has not implemented
  def is_stochastic(self) -> bool:
    raise NotImplementedError #Throws error when method is called
