...
class PointMassZeroSumEnv(BaseZeroSumEnv):
    """
    Zero-Sum Environment for a Point Mass with Adversarial Interactions.
    """
    ...
    def get_done_and_info(
        ...
        # Gets info
        info = {"done_type": done_type, "g_x": g_x, "l_x": l_x, "binary_cost": binary_cost, "point_mass_identifier": True}
    ...
    def get_obsrv(self, state: np.ndarray) -> np.ndarray:
        ...
        return self.agent.dyn.obs

    def render(self):
        return super().render()

    def report(self):
        print("Point Pybullet initialized")